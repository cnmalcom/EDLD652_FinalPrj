...
pacman::p_load(edld652, tidyverse, psych, rio, here, forcats, arrow, dplyr, stringr, readr, tidyr, corrplot, Hmisc, scales, RColorBrewer, ggmap, devtools, leaidr, piggyback, mapproj, maptools, gitcreds, virdis, knitr, kableExtra, xtable, PerformanceAnalytics)
```
...
```{r corr6, echo=FALSE}
corrplot(cor(tbd_corr), method = 'ellipse', type = 'lower', addCoef.col = "black",    # Change font size of correlation coefficients
         number.cex = 0.5, col = COL2('PRGn', 10))

```



Correlation Matrix - how to change colors, labels, font size?
```{r corr7, echo=FALSE}
...
Try left_join instead of merge
